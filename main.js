...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const orbitSteps = [
        { id: '01', title: 'سرعة والتزام', text: 'نلتزم بجدول تسليم دقيق وسرعة تنفيذ عالية؛ تبدأ حملتك وتنطلق خلال أيام من تأكيد باقتك، دون أي تأخير أو أعذار.' },
        { id: '02', title: 'استديوهات مجهزة', text: 'ننتج محتواك داخل استديوهات مجهزة بأحدث الكاميرات والإضاءة والديكور، لتحصل على جودة بصرية احترافية توازي كبرى العلامات التجارية.' },
        { id: '03', title: 'مركز ادارة ومتابع', text: 'نتابع أداء حملاتك لحظياً عبر مركز إدارة متكامل؛ نرصد النتائج ونعدّل الخطة فوراً لضمان أعلى عائد على استثمارك.' }
    ];
